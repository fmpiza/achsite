                ...
                <div class="col-md-12">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="navbar-header">           
                            ...
                            <span><a href="index.html"> <h1 class="m-0"> <font size=4 color="black">Arusha City Hospital</font></h1></a></span>       
                        </div> 
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" data-hover="dropdown" data-animations-delay="1.8s" data-animations="fadeInUp">
                            <ul class="nav navbar-nav bg-none navbar-right style-3">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span data-hover="Depertment"><font color="#00B092"></b>Services</b></font></i></span></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="testing.html"><font color="black">Facility Items</font></a>
                                        </li>
   					...
   					<li><a href="https://hfrportal.moh.go.tz/web/index.php?r=portal%2Fadvanced-search"><font color="black">TANZANIA Health Facilities</font></a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="fieldstudent1.php"><font color="black">Swahili</font></a>
                                        </li>
                                        <li><a href="fieldstudent.php"><font color="black">English</font></a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                                ...
                                                <li>
                                                    <table class="table table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product">       <a href="#" class="menu-shop-btn">Online Meeting</a></td>
                    ...
                    <div class="col-md-3">
                      <div class="footer-item">
                        ...
                        <ul class="footer-list border-deshed color-icon">
                          ...
                          <li><i class="pe-7s-angle-right"></i><a href="ictpolicyarushacityhospital.pdf"><font color="black">ICT Policy</font></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <p><font color="black">Copyright @ </font><font color="black">2026, ARUSHA CITY HOSPITAL. Developed and Maintained by</font> <a target="_blank" href="https://fmpiza.github.io/webfridolin">ICT UNIT</a></p>
          </div>
        </div>
      </div>
    </section>
