...
<head>
    ...
    <meta name="description" content="https://fmpiza.github.io/webfridolin">
    ...
    <!-- Favicon -->
    <link href="favbg.png" rel="shortcut icon" type="image/png">
                ...
                <div class="col-md-12">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="navbar-header">           
                            ...
                            <span><a href="index1.html"> <h1 class="m-0"> <font size=4 color="black">Hospitali ya Jiji Arusha</font></h1></a></span>       
                        </div>
                            ...
                            <ul class="nav navbar-nav bg-none navbar-right style-3">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="physiotherapy1.html"><font color="black">Huduma Mazoezi</font></a>
                                        </li>
                                        <li><a href="dental1.html"><font color="black">Huduma ya Meno</font></a>
                                        </li>
                                        <li><a href="eye1.html"><font color="black">Huduma ya Macho</font></a>
                                        </li>
                                        <li><a href="consultation1.html"><font color="black">Huduma ya Ushauri</font></a>
                                        </li>
                                        <li><a href="surgery1.html"><font color="black">Huduma ya Upasuaji</font></a>
                                        </li>
                                        <li><a href="labor1.html"><font color="black">Wodi ya Uzazi</font></a>
                                        </li>
                                        <li><a href="delivery1.html"><font color="black">Huduma ya Kujifungua</font></a>
                                        </li>
                                        <li><a href="nutrition1.html"><font color="black">Huduma ya Lishe</font></a>
                                        </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="finance1.html"><font color="black">Fedha na Mipango</font></a>
                                        </li>
                                        <li><a href="ict1.html"><font color="black">TEHAMA</font></a>
                                        </li>
                                        <li><a href="laboratory1.html"><font color="black">Maabara</font></a>
                                        </li>
                                        <li><a href="opd1.html"><font color="black">Wagonjwa wa Nje</font></a>
                                        </li>
                                        <li><a href="ipd1.html"><font color="black">Wagonjwa wa Ndani</font></a>
                                        </li>
                                        <li><a href="laborward1.html"><font color="black">Wodi ya Wazazi</font></a>
                                        </li>
                                        <li><a href="rch1.html"><font color="black">Mama na Mtoto</font></a>
                                        </li>
                                        <li><a href="eyedepartment1.html"><font color="black">Macho</font></a>
                                        </li>
                                        <li><a href="dentaldepartment1.html"><font color="black">Meno</font></a>
                                        </li>
                                        <li><a href="pharmacy1.html"><font color="black">Famasi</font></a>
                                        </li>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span data-hover="Doctors"><font color="#00B092"><b>Viambata</b></font> </span></a>
                                     <ul class="dropdown-menu">
                                        ...
                                        <li><a href="team-details1.html"><font color="black">Tenda</font></a></li>
                                            <li><a href="depertment-3copy.html"><font color="black">Taarifa</font></a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="blog-left1.html"><font color="black">Masuala ya Mtandao</font></a>
                                        </li>
					    ...
					    <li><a href="https://hfrportal.moh.go.tz/web/index.php?r=portal%2Fadvanced-search"><font color="black">Vituo vya Afya TANZANIA</font></a>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="fieldstudent1.php">Swahili</a>
                                        </li>
                                        <li><a href="fieldstudent.php">English</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                    ...
                    <div class="col-md-3">
                      <div class="footer-item">
                        ...
                        <ul class="footer-list border-deshed color-icon">
                          ...
                          <li><i class="pe-7s-angle-right"></i><a href="ictpolicyarushacityhospital.pdf"><font color="black">Sera ya TEHAMA</font></a></li>
                          <li><i class="pe-7s-angle-right"></i><a href="matibabuform.pdf"><font color="black">Fomu ya Matibabu</font></a></li>
                          <li><i class="pe-7s-angle-right"></i><a href="nhifclaimform.pdf"><font color="black">NHIF Claim Form</font></li>
                          <li><i class="pe-7s-angle-right"></i><a href="anaesthesiarecord.pdf"><font color="black">Anaesthesia Record</font></a></li>
							  <li><i class="pe-7s-angle-right"></i><a href="handoverform.pdf"><font color="black">Hand Over Form</font></a></li>
							<li><i class="pe-7s-angle-right"></i><a href="fomumsamaha.pdf"><font color="black">Exemption Form</font></a></li>
								<li><i class="pe-7s-angle-right"></i><a href="sicksheet.pdf"><font color="black">Sick Sheet</font></a></li>
								<li><i class="pe-7s-angle-right"></i><a href="organogram.pdf"><font color="black">Organogram</font></a></li>
								<li><i class="pe-7s-angle-right"></i><a href="stgbook.pdf"><font color="black">STG Book</font></a></li>
							<li><i class="pe-7s-angle-right"></i><a href="rostertemplate.xlsx"><font color="black">Roster Template</font></a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-md-3">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <p><font color="black">Haki Miliki @ 2026, HOSPITALI YA JIJI ARUSHA. Umetengenezwa na Kusimamiwa na</font> <a target="_blank" href="https://fmpiza.github.io/webfridolin">Kitengo cha TEHAMA</a></p>
          </div>
        </div>
      </div>
    </section>
